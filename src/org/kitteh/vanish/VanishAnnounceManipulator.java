...
public class VanishAnnounceManipulator {
    ...
    /**
     * Call a fake join announce for the player. Only fires if the server
     * previously was saying they were offline
     * 
     * @param player
     */
    ...
    /**
     * Call a fake quit for the player. Only fires if the server previously was
     * saying they were online
     * 
     * @param player
     */
    ...
    /**
     * Called when a player's vanish status has been toggled If the player has a
     * queued up join announce from a silentjoin, it will fire at this time.
     * 
     * @param player
     */
