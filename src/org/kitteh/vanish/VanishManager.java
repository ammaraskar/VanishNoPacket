...
public class VanishManager {
    ...
    /**
     * Smack that vanish list. Smack it hard. But really, don't call this.
     */
    public void startup() {
    ...
    /**
     * Toggle a player's visibility Called when a player calls /vanish Talks to
     * the player and everyone with vanish.see
     * 
